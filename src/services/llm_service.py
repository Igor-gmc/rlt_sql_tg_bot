...
- "сколько разных видео" → "count_distinct" (distinct_field: "video_id" или не указывай)
- "сколько разных/уникальных креаторов" → "count_distinct" (distinct_field: "creator_id", source: "videos")
- "в скольких разных днях/датах" → "count_distinct" (distinct_field: "date")
...
Верни ТОЛЬКО валидный JSON (без markdown, без пояснений):
{
  ...
  "distinct_field": "creator_id" | "video_id" | "date" | null,
  "filters": {
...
Вопрос: "Сколько разных креаторов имеют хотя бы одно видео, которое набрало больше 100000 просмотров?"
{"source":"videos","aggregation":"count_distinct","metric":null,"distinct_field":"creator_id","filters":{"threshold_field":"views","threshold_op":">","threshold_value":100000}}

Вопрос: "Для креатора с id aca1061a9d324ecf8c3fa2bb32d7be63, в скольких разных календарных днях ноября 2025 года он публиковал хотя бы одно видео?"
{"source":"videos","aggregation":"count_distinct","metric":null,"distinct_field":"date","filters":{"creator_id":"aca1061a9d324ecf8c3fa2bb32d7be63","date_from":"2025-11-01","date_to":"2025-11-30"}}
